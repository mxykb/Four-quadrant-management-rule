 ...
 * 番茄钟AI功能权限适配器
 */
public class PomodoroFunctionAdapter extends RecyclerView.Adapter<PomodoroFunctionAdapter.ViewHolder> {
    
    private List<PomodoroFunction> functions;
    private OnFunctionPermissionChangeListener listener;

    public interface OnFunctionPermissionChangeListener {
        void onPermissionChanged(PomodoroFunction function, boolean enabled);
    }

    public PomodoroFunctionAdapter(List<PomodoroFunction> functions, OnFunctionPermissionChangeListener listener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_pomodoro_function, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        PomodoroFunction function = functions.get(position);
    ...
    public void updateFunctions(List<PomodoroFunction> newFunctions) {
